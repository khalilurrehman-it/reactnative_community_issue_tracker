...
const colors = {
  ...
  successGreen: '#10B981', // Success Green (Positive)
  warningOrange: '#F59E0B', // Warning Orange
  errorRed: '#DC2626', // Error Red (Danger)
  lightGrayBackground: '#E5E7EB', // Light Gray Background
  darkBackground: '#121212', // Dark Background (Dark Mode)
  darkGrayText: '#333333', // Default Dark Gray Text
  whiteText: '#FFFFFF', // White Text (Light text on dark backgrounds)
};
